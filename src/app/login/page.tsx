    ...
    <div className="relative min-h-screen bg-slate-50 flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="relative flex w-full flex-col justify-center px-12 py-16 md:w-1/2 md:px-20">
        <div className="max-w-md">
          {/* 상단 카피 */}
          <p className="mb-3 text-lg font-medium text-slate-600 leading-relaxed">
            데이터 품질 검수의{' '}
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 text-xs text-gray-400">
                <button type="button" className="hover:text-slate-600 transition-colors">아이디 찾기</button>
                <span>|</span>
                <button type="button" className="hover:text-slate-600 transition-colors">비밀번호 찾기</button>
              </div>
            </div>
          </form>
